...
int main()
{
	...
	cout << "--- TP 1 EXO 1 ---" << endl<<endl;
	cout <<	"Entrez une chaine de caracteres:"; //Demande de rentrer une chaine
	...
	cout <<endl<<"Vous avez mis "<<temps<<" seconde(s)!"<<endl<<endl; //Affichage du temps de saisie
	...
	int temps_systeme = clock(); //Fonction permettant de savoir cb de temps a dure le processus
	cout << "Le programme a dure " << temps_systeme/float(CLOCKS_PER_SEC) << " secondes!" << endl; //Affichage

	//  Attente de fin
	cout <<endl<<"Entrez une touche pour quitter..." << endl;
	cin>>texte;
}
